        ...
        <div class="w-full lg:w-1/2">
          <div class="lg:max-w-lg">
            ...
            <p class="mt-3 text-gray-600 dark:text-gray-400">
              be the first one to read our jokes.
              <span class="font-medium text-blue-500">Avery day!</span>
            </p>
            ...
            <div class="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
              ...
              <button
                class="w-full px-5 py-2 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-blue-600 rounded-lg lg:w-auto lg:mx-4 hover:bg-blue-500 focus:outline-none focus:bg-blue-500"
              >
                Subscribe
              </button>
            </div>
